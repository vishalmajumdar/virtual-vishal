        ...
        <div className="hero-content text-center flex-col">
          <div className="max-w-4xl">
            ...
            <div className="text-left">
              <p>
                At Virtual Vishal, accessible from
                https://virtual-vishal.vercel.app/, one of our main priorities
                is the privacy of our visitors. This Privacy Policy document
                contains types of information that is collected and recorded by
                Virtual Vishal and how we use it.
              </p>
              <br />
              <p>
              ...
              <p>
                ...
                information that they shared and/or collect in Virtual Vishal.
              ...
              <br />
              <h2 className="text-lg font-bold font-serif mb-1">Log Files</h2>

              <p>
                Virtual Vishal follows a standard procedure of using log files.
              ...
              <p>
                ...
                the advertising partners of Virtual Vishal.
              </p>
              <br />
              ...
              <p>
                ...
                respective advertisements and links that appear on Virtual
                Vishal, which are sent directly to users' browser. They
              ...
              <p>
                Note that Virtual Vishal has no access to or control over these
              ...
              <p>
                Virtual Vishal's Privacy Policy does not apply to other
              ...
              <p>
                Virtual Vishal does not knowingly collect any Personal
              ...
              <h2 className="text-lg font-bold font-serif mb-1">Contact Us</h2>
